...
public class StringManager {
    public static String guiTitle = "TrayUtils Settings";
    public static String trayTitle = "TrayUtils";

    public static String showGui = "Show Gui";
    ...
    public static String keybind = "Keybind";
